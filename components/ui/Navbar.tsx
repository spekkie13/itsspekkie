      ...
      <nav className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <a
            ...
            className="flex items-center gap-2 bg-gold-400/10 border border-gold-400/30 text-gold-400 text-xs font-semibold uppercase tracking-widest px-3 py-1.5 rounded-full hover:bg-gold-400/20 transition-colors"
          >
